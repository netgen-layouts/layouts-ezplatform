...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            sass: {
                files: ['<%= config.resources_dir %>/sass/admin/{,*/}*.{scss,sass}'],
                tasks: ['sass', 'postcss'],
            },
        },
        ...
        sass: {
            ...
            dist: {
                files: [{
                    expand: true,
                    cwd: '<%= config.resources_dir %>/sass/admin',
                    src: ['*.{scss,sass}'],
                    dest: '.tmp/css',
                    ext: '.css',
                }],
        ...
        postcss: {
            ...
            dist: {
                files: [{
                    ...
                    cwd: '.tmp/css/',
                    src: '{,*/}*.css',
                    dest: '<%= config.public_dir %>/css/admin',
                }],
            },
        },
    });

    grunt.registerTask('build', 'Build the assets', function () {
        grunt.task.run([
            'lockfile',
            'sass:dist',
            'postcss',
